...
4. Do NOT force matches: if no gold item cleanly aligns, use None.
5. Preserve predicted order: output tuples follow the input predicted sequence; length of output list equals number of predicted items.
